...
main_page_content='''
 <body>
    <div id="header">
            <img src="http://media.gettyimages.com/photos/film-picture-id468089445?s=170x170&w=1007"  alt="logo" class="im1"/>
        MOVIE TRAILERS <img src="http://media.gettyimages.com/photos/film-picture-id468089445?s=170x170&w=1007" alt="logo" class="im2"/></div>
    <main>
        <div class="container">
            <div class="mv" onclick="changeVideo('gfgeIZyrIM0')">
                <img src="http://www.weaverstreetmarket.coop/wp-content/uploads/2016/06/movie-poster-nemo.jpeg" alt="nemo">
                <figcaption style="text-align: center; color: black;">
                    <b>Nemo</b>
                </figcaption>
            </div>
            <div class="mv1" onclick="changeVideo('IfePzXxIuvc')">
                <img src="https://image.tmdb.org/t/p/w185/wbVGRBYPRRahIZNGXY9TfHDUSc2.jpg" alt="snowwhite">
                <figcaption style="text-align: center; color:black;">
                    <b>Snow White</b>
                </figcaption>
            </div>
            <div class="mv2" onclick="changeVideo('WBYdp2sOut0')">
                <img src="https://upload.wikimedia.org/wikipedia/en/b/b4/Tom_and_Jerry_-_The_Movie_Poster.png" alt="tom&jerry">
                <figcaption style="text-align: center; color: black;">
                    <B>Tom and Jerry</B>
                </figcaption>
            </div>
            <div class="mv3" onclick="changeVideo('LKFuXETZUsI')">
                <img src="https://cdn.disneymovieclub.go.com/static/Catalog/Acquisition_Agnostic_191x269/Moana_Acq.jpg" alt="Moana">
                <figcaption style="text-align: center; color: black;">
                    <B>Moana</B>
                </figcaption>
            </div>
            <div class="mv4" onclick="changeVideo('ORFWdXl_zJ4')">
                <img src="https://www.cardiffboxoffice.com/asset/Event/11505/up.jpg" alt="up">
                <figcaption style="text-align: center; color:black;">
                    <b>UP</b>
                </figcaption>
            </div>
            <div class="mv5" onclick="changeVideo('eq-bqSvx0R8')">
                <img src="https://www.columbiaassociation.org/wp-content/uploads/2016/03/ShowImage-id=10603&t=635689308124800000.jpeg" alt="cinderella">
                <figcaption style="text-align: center; color: black;">
                    <b>Cinderella</b>
                </figcaption>
            </div>
